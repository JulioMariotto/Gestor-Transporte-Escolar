...
<c:if test="${login == null}">
   <jsp:forward page="/index.jsp">
        ...
        <jsp:param name="red" value="Saidas?action=visualizar&id=${despesa.id}" />
    </jsp:forward> 
</c:if>
    ...
    <body>
        ...
        <div class="container" style="padding-top: 1%">
            <div class="jumbotron">
                ...
                <a href="Saidas?action=delete&id_despesa=${despesa.id}" class="btn float-right btn-danger active" onclick="return confirm('Tem certeza que deseja excluir esta despesa?')">Excluir</a>
                ...
                <c:if test="${abastecimento != null}" >
                    ...
                    <p><strong>Valor: </strong><fmt:formatNumber type="currency" value="${despesa.valor}" /></p>
                ...
                <c:if test="${abastecimento != null}" >
                    ...
                    <p><strong>Data: </strong>${fn:substring(despesa.data, 8, 10)}/${fn:substring(despesa.data, 5, 7)}/${fn:substring(despesa.data, 0, 4)}</p>
                ...
                <c:if test="${manutencao != null}" >
                    ...
                    <p><strong>Quilometragem: </strong>${manutencao.kilometragem}</p>
